...
发布前检查清单见 [docs/deployment-checklist.md](docs/deployment-checklist.md)，部署后真实链路验收见 [docs/production-smoke-test.md](docs/production-smoke-test.md)。GitHub Actions `CI` 会在 `main` / `master` 的 push 和 pull request 上执行测试、lint、构建、sitemap 稳定性检查、高危依赖审计和 Playwright E2E。
